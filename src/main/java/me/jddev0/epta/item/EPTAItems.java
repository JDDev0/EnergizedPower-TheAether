...
public final class EPTAItems {
    ...
    public static final RegistryObject<Item> SKYROOT_HAMMER = ITEMS.register("skyroot_hammer",
            () -> new HammerItem(AetherItemTiers.SKYROOT, new Item.Properties().tab(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    public static final RegistryObject<Item> HOLYSTONE_HAMMER = ITEMS.register("holystone_hammer",
            () -> new HammerItem(AetherItemTiers.HOLYSTONE, new Item.Properties().tab(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    public static final RegistryObject<Item> ZANITE_HAMMER = ITEMS.register("zanite_hammer",
            () -> new HammerItem(AetherItemTiers.ZANITE, new Item.Properties().tab(EPCreativeModeTab.ENERGIZED_POWER_TAB)));
    public static final RegistryObject<Item> GRAVITITE_HAMMER = ITEMS.register("gravitite_hammer",
            () -> new HammerItem(AetherItemTiers.GRAVITITE, new Item.Properties().tab(EPCreativeModeTab.ENERGIZED_POWER_TAB)));

    public static final RegistryObject<Item> SKYROOT_DIRTY_WATER_BUCKET = ITEMS.register("skyroot_dirty_water_bucket",
            () -> new SkyrootBucketItem(EPFluids.DIRTY_WATER, new Item.Properties().tab(EPCreativeModeTab.ENERGIZED_POWER_TAB).
